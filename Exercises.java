...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		String ending = out.substring(2, 4);
	...
	public boolean endsLy(String str) {
		...
		if(str.substring((str.length() - 2), str.length()).equals(check)) {
			return true;
		}
		return false;
	}
	...
	public int countXX(String str) {
		...
		while (str.indexOf("xx") != -1){
			int currentFirst = str.indexOf("xx");
			str = str.substring(currentFirst + 1); 
			counter++;
		 }
		 return counter;
	}
	...
	public boolean doubleX(String str) {
		...
		if (start == -1) {
			...
			if (start != (str.length() - 1) && str.charAt(start + 1) == 'x') {
				return true;
			}
		}
